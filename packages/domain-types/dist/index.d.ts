...
export type HousekeepingTaskStatus = "Draft" | "Queued" | "Assigned" | "In Progress" | "Paused" | "Completed" | "Inspection Required" | "Rework Required" | "Skipped" | "Cancelled";
/**
...
export type MaintenanceTicketState = "Reported" | "Assigned" | "In Progress" | "Waiting for Parts" | "On Hold" | "Resolved" | "Verification Required" | "Released" | "Closed" | "Duplicate";
/** `maintenance_ticket.priority`. Wider than housekeeping's, and different. */
export type MaintenanceTicketPriority = "Low" | "Normal" | "High" | "Urgent" | "Guest Impacting" | "Safety Critical" | "Revenue Blocking";
/**
