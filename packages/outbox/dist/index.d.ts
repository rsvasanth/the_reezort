...
export { drainOnce, fromWireResult, toWireOperation, SYNC_PUSH, type WireOperation, type WireResult, } from "./transport";
...
export { isTerminal, needsReview, type ConflictDetail, type OutboxRow, type OutboxState, type PendingUpload, type SyncResult, } from "./types";
