 ...
 */
const buttonVariants = cva("flex-row items-center justify-center gap-2 rounded-md disabled:opacity-50", {
    variants: {
        variant: {
...
const Button = React.forwardRef(({ className, variant, size, ...props }, ref) => (_jsx(TextClassContext.Provider, { value: buttonTextVariants({ variant, size }), children: _jsx(Pressable, { ref: ref, role: "button", className: cn(buttonVariants({ variant, size }), className), ...props }) })));
