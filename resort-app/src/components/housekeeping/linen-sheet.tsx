			...
			<SheetContent side="right" className="flex w-full flex-col gap-0 sm:max-w-xl" data-testid="linen-sheet">
				...
				<div className="flex flex-1 flex-col gap-4 overflow-y-auto px-4 py-3">
							...
							{par.items.map((i) => {
								...
								return (
									<motion.div
										...
										className={`grid grid-cols-[minmax(0,1.6fr)_60px_70px_70px_70px] gap-2 border-b px-3 py-1.5 text-sm last:border-b-0 ${belowPar ? "bg-warning" : ""}`}
					...
					{summary.short > 0 || summary.damaged > 0 || summary.missing > 0 ? (
						<div className="flex items-center gap-1 text-xs text-warning" data-testid="linen-summary">
